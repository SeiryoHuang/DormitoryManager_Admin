...
public interface ClassService {
    ...
    //获取用户列表
    public PageInfo<Clazz> getClassList(@Param("c_classname") String c_classname, @Param("c_classid") String c_classid, @Param("c_counsellor") String c_counsellor,@Param("c_id")Integer c_id, Integer pageIndex, Integer pageSize);
